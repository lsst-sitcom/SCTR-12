...
The current status of test plan \href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testPlan/LVV-P64}{LVV-P64} in Jira is \textbf{ Completed }.
...
\multicolumn{3}{c}{Jira Attachments} \\ \hline
 To LVV-C112 results &
  CCWTestingPlan-Results.docx & \attachfile{attachments/CCWTestingPlan-Results.docx}\\ \hline
   \end{longtable}
...
\multicolumn{2}{p{10.9cm}}{\textbf{ CCW Functional Re-verification }} & Completed \\\hline
